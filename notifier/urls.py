...
urlpatterns = [
    ...
    path('organisation/<str:org>/webhook/<str:user>', views.organisation_webhook, name="organisation_webhook"),
    path('organisation/<str:org>/webhook_add', views.add_org_webhook, name="add_org_webhook"),
    path('organisation/<str:org>/webhook_delete', views.delete_org_webhook, name="delete_org_webhook"),
